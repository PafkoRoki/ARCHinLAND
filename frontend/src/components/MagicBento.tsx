...
const DEFAULT_GLOW_COLOR = '254, 80, 0';
...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    ...
    description: 'ARCH in LAND',
    label: 'Biuro prowadzone przez Andrzeja Kurkę. Od 30 lat łączymy projektowanie architektoniczne z wiedzą techniczną, tworząc wielobranżowe, nowoczesne realizacje dopasowane do miejsca i wymagań prawa budowlanego.'
  }
];
